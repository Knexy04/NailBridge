...
const RegistrationJudge = () => {
    ...
    const onSubmit = async () => {
        try {
            ...
            // eslint-disable-next-line
            const {data} = await axios.post('/requestjudge', fields );
    ...
    return (
        <div className="registration">
            ...
            <article>Оставьте заявку, чтобы стать судьей</article>
            <div className="reginputs">
                <form>
                    ...
                    <div className="achievements">
                        <label>Напишите свои достижения (максимум - 5)</label>
                        <ul className="achievements_list">
                            <li className="achievement">
                                <textarea value={li_1} onChange={(e) => setLi1(e.target.value)} placeholder="Достижение 1"/>
                            </li>
                            <li className="achievement">
                                <textarea value={li_2} onChange={(e) => setLi2(e.target.value)} placeholder="Достижение 2"/>
                            </li>
                            <li className="achievement">
                                <textarea value={li_3} onChange={(e) => setLi3(e.target.value)} placeholder="Достижение 3"/>
                            </li>
                            <li className="achievement">
                                <textarea value={li_4} onChange={(e) => setLi4(e.target.value)} placeholder="Достижение 4"/>
                            </li>
                            <li className="achievement">
                                <textarea value={li_5} onChange={(e) => setLi5(e.target.value)} placeholder="Достижение 5"/>
                            </li>
                        </ul>
                    </div>
