        ...
        <div>
            <div className={module.user}>
                <div className={module.userblock}>
                    ...
                    <div className={module.infoblock} ><strong
                        className={module.strong2}>
                        {teamInfo[0]?.[0]?.team?.[0]?.length !== 0 && teamInfo[0]?.team?.[0]?.teamTrainer?.length !== 0 ? (
                            teamInfo[0]?.team?.[0]?.teamTrainer.map((obj) => (
                                obj._id === id ? obj.fullName : ""
                            ))
                        ) : (
                            ""
                        )}
